...
using SessionManager = MESL.SqlRace.Domain.SessionManager;
...
namespace MAT.SQLRace.HelloData
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            ConnectionString = $@"DbEngine=SQLite;Data Source=D:\Tickets\89068\Programnation_251104193749.ssn2;";
            ...
            var good = LoadSsn2(@"DbEngine=SQLite;Data Source=D:\Test Data\SSN2\UK_Quali_1_220818095927.ssn2;");
            var bad = LoadSsn2(@"DbEngine=SQLite;Data Source=D:\Tickets\89068\Programnation_251104193749.ssn2;");
        ...
        private static IClientSession LoadSsn2(string connectionString)
        {
            var ssn2Summaries = sessionManager.Find(connectionString, null, null, null);
            return sessionManager.Load(ssn2Summaries[0].Key, ssn2Summaries[0].GetConnectionString());
        }
