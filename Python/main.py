...
def set_cursor(keys, connection_strings, timestamp):
    ...
    print("Waiting for ATLAS to open") # here, instead of sleep, callbacks from Automation API MAT.Atlas.Automation.Client.Services.ApplicationServiceClient may be used to make it more elegant and reliable
    time.sleep(15)
    ...
    # Waiting for session(s) to load
    time.sleep(15) # here, instead of sleep, callbacks from Automation API MAT.Atlas.Automation.Client.Services.ApplicationServiceClient may be used to make it more elegant and reliable
